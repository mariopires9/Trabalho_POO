...
${OBJECTDIR}/Assalta.o: Assalta.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Assalta.o Assalta.cpp
...
${OBJECTDIR}/ComeMigalha.o: ComeMigalha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComeMigalha.o ComeMigalha.cpp

${OBJECTDIR}/Comunidade.o: Comunidade.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Comunidade.o Comunidade.cpp

${OBJECTDIR}/Configuracao.o: Configuracao.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Configuracao.o Configuracao.cpp

${OBJECTDIR}/Consola.o: Consola.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consola.o Consola.cpp

${OBJECTDIR}/Cuidadora.o: Cuidadora.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cuidadora.o Cuidadora.cpp

${OBJECTDIR}/Exploradora.o: Exploradora.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Exploradora.o Exploradora.cpp

${OBJECTDIR}/Foge.o: Foge.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Foge.o Foge.cpp

${OBJECTDIR}/Formigas.o: Formigas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Formigas.o Formigas.cpp
...
${OBJECTDIR}/Migalhas.o: Migalhas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Migalhas.o Migalhas.cpp
...
${OBJECTDIR}/Ninho.o: Ninho.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ninho.o Ninho.cpp

${OBJECTDIR}/Passeia.o: Passeia.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Passeia.o Passeia.cpp

${OBJECTDIR}/Persegue.o: Persegue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Persegue.o Persegue.cpp

${OBJECTDIR}/ProcuraMigalha.o: ProcuraMigalha.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcuraMigalha.o ProcuraMigalha.cpp

${OBJECTDIR}/Protege.o: Protege.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Protege.o Protege.cpp

${OBJECTDIR}/Regra.o: Regra.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Regra.o Regra.cpp
...
${OBJECTDIR}/VaiParaNinho.o: VaiParaNinho.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VaiParaNinho.o VaiParaNinho.cpp
